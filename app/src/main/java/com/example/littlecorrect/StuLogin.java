...
public class StuLogin extends Activity implements View.OnClickListener{
    ...
    private void log(){
        ...
        Request request = new Request.Builder()
                .url(String.format(getString(R.string.ip))+"StudentLogin")
                .post(r)
                .build();
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if(responsedata.equals("true"))
                {
                    ...
                    intent.setClass(StuLogin.this, StuMain.class);
                    startActivity(intent);
                    //StuLogin.this.finish();
                }
                else
                {
                    Looper.prepare();
                    Toast.makeText(StuLogin.this,"用户名或密码错误",Toast.LENGTH_SHORT).show();
                    Looper.loop();
                }
            }
        });
    ...
    public void skip(View view){
        Intent intent = new Intent();
        intent.setClass(StuLogin.this,StuRegister.class);
        startActivity(intent);
        StuLogin.this.finish();
    }
}
